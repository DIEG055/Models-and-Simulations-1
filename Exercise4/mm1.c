...
main()  /* Main function. */
{
    ...
    fscanf(infile, "%f %f %d", &mean_interarrival, &mean_service_1,
           &mean_service_2);
    ...
    fprintf(outfile, "Mean interarrival time%11.3f minutes\n\n",
            mean_interarrival);
    fprintf(outfile, "Mean service 1 time%16.3f minutes\n\n", mean_service_1);
    fprintf(outfile, "Mean service 2 time%16.3f minutes\n\n", mean_service_2);
...
void arrive2(void){
    ...
    }else
    {
        ...
        time_next_event[3] = sim_time + poisson(mean_service_2);
    }
};
...
void arrive(void)  /* Arrival event function. */
{
    ...
    else
    {
        ...
        time_next_event[2] = sim_time + poisson(mean_service_1);
    }
}
